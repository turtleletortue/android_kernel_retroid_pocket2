...
#ifdef CONFIG_FLASHLIGHT_GPIO_MODE
extern int leds_strobe_get_gpio_info(struct platform_device *pdev);
#endif
...
#ifdef CONFIG_FLASHLIGHT_GPIO_MODE
static const struct of_device_id gpio_flashlight_of_ids[] = {
	{.compatible = "realphone,gpio_flashlight",},
	{}
};
#endif
...
static struct platform_driver flashlight_platform_driver = {
	...
	.driver = {
		   ...
		   .owner = THIS_MODULE,
#ifdef CONFIG_FLASHLIGHT_GPIO_MODE
		   .of_match_table = gpio_flashlight_of_ids,
#endif
		   },
};
