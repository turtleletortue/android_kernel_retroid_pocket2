...
void disp_pwm_power_on(void)
{
	ddp_pwm_power_on(DISP_MODULE_PWM0,0);
}
EXPORT_SYMBOL(disp_pwm_power_on);

void disp_pwm_power_off(void)
{
	ddp_pwm_power_off(DISP_MODULE_PWM0,0);
}
EXPORT_SYMBOL(disp_pwm_power_off);
