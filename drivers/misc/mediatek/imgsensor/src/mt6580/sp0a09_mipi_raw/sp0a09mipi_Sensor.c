...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .startx = 0,
        .starty = 0,
		.grabwindow_width = 648,//4192,
		.grabwindow_height = 488,//3104,
...
{{  648, 488,  0, 0, 648, 488, 648, 488, 0, 0, 648, 488,  0, 0, 648, 488}, // Preview 2112*1558                          
 {  648, 488,  0, 0, 648, 488, 648, 488, 0, 0, 648, 488,  0, 0, 648, 488}, // capture 4206*3128                          
 {  648, 488,  0, 0, 648, 488, 648, 488, 0, 0, 648, 488,  0, 0, 648, 488}, // video                                      
 {  648, 488,  0, 0, 648, 488, 648, 488, 0, 0, 648, 488,  0, 0, 648, 488}, //hight speed video                           
 {  648, 488,  0, 0, 648, 488, 648, 488, 0, 0, 648, 488,  0, 0, 648, 488},}; // slim video
...
static void sensor_init(void)
{
  ...
  //yan
  write_cmos_sensor(0x31, 0x06); //bit1 bit2 (begin with 0)
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			printk("sp0a09 id = [0x%x]",*sensor_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
                //yan read device info
                set_global_cam_name("sp0a09_mipi_raw(30w)");
                //yan end
                return ERROR_NONE;
            }
            retry--;
