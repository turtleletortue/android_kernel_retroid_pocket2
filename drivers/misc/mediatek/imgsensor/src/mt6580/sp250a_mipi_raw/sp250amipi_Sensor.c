 ...
 static u32 strtol(const char *nptr, u8 base)
{
 ...
 static u8 SP250aMIPI_Initialize_from_T_Flash()
{
...
UINT32 SP250aMIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SP250aMIPI_RAW_SensorInit    */
