...
#endif	
#if defined(ST7701_WVGA_DSI_VDO_BOE)
    &st7701_wvga_dsi_vdo_boe_drv,
#endif
#if defined(ST7701_FWVGA_DSI_VDO_BOE)
    &st7701_fwvga_dsi_vdo_boe_drv,
#endif	
#if defined(NT35521_DSI_VDO_HD_AUO)
    &nt35521_dsi_vdo_hd_auo_drv,
#endif

#if defined(ILI9885U_HD_DSI_VDO_BOE)
	&ili9885u_hd_dsi_vdo_boe_lcm_drv,
#endif

#if defined(ILI9881C_HD_DSI_VDO_BOE)
	&ili9881c_hd_dsi_vdo_boe_lcm_drv,
#endif
...
#if defined(RM67200_HD720_DSI_VDO)
	&rm67200_hd720_dsi_vdo_lcm_drv,
#endif
	
#if defined(MTK_LCM_DEVICE_TREE_SUPPORT)
	&lcm_common_drv,
#else
#if defined(JD9261_DSI_VDO_QHD)
	&jd9261_dsi_vdo_qhd_lcm_drv,
#endif
...
#if defined(ST7797S_HVGA)
    &st7797s_hvga_dsi_vdo_v458_dlt_drv,
#endif

#if defined(NT35521_DSI_VDO_HD_T510_LG)
    &nt35521_dsi_vdo_hd_t510_lg_drv,
#endif

#if defined(ILI9807_DSI_VDO_QHD)
    &ili9807_dsi_vdo_qhd_lcm_drv,
#endif
...
//yan read device info
void set_global_lcd_name(char* name)
{
    printk("set_global_lcd_name: %s\n", name);
    if (strlen(name) > 63) {
        printk("name length > 63, exit\n");
        return;
    }
    memset(g_lcd_name, 0, sizeof(g_lcd_name));
    strcpy(g_lcd_name, name);
    printk("g_lcd_name: %s\n", g_lcd_name);
}
//yan end
