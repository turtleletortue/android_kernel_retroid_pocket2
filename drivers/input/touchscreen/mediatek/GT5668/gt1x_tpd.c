...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	input_set_capability(tpd->dev, EV_KEY, TPD_GES_KEY_UP); 
	input_set_capability(tpd->dev, EV_KEY, TPD_GES_KEY_DOWN);
	input_set_capability(tpd->dev, EV_KEY, TPD_GES_KEY_LEFT); 
	input_set_capability(tpd->dev, EV_KEY, TPD_GES_KEY_RIGHT);
