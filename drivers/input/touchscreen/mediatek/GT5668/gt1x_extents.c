...
#define DRV_CTP_GESTURE_NUM	20

 int  drv_ctp_str[DRV_CTP_GESTURE_NUM] = {
 0x61/*a*/,0x62/*b*/,0x63/*c*/,0x64/*d*/,0x65/*e*/,
 0x67/*g*/,0x68/*h*/,0x6D/*m*/,0x6f/*o*/,0x71/*q*/,
 0x73/*s*/,0x76/*v*/,0x77/*w*/,0x79/*y*/,0x7a/*z*/,
 0xAA/*left*/,0xBB/*right*/,0xAB/*up*/,0xBA/*down*/,0xCC/*doubel*/
 };

int  drv_ctp_num[DRV_CTP_GESTURE_NUM] = 
 {
 
	 KEY_A    /*a*/,      KEY_B/*b*/,             KEY_C/*c*/,          KEY_D/*d*/,             KEY_E/*e*/,
	 KEY_G    /*g*/,      KEY_H/*h*/,             KEY_M/*m*/,        KEY_O/*o*/,             KEY_Q/*q*/,
	 KEY_S   /*s*/,      KEY_V/*v*/,             KEY_W/*w*/,        KEY_Y/*y*/,              KEY_Z/*z*/,
	 TPD_GES_KEY_RIGHT/*KEY_LEFT-left*/,TPD_GES_KEY_LEFT/*KEY_RIGHT-right*/,TPD_GES_KEY_DOWN/*KEY_UP-up*/,TPD_GES_KEY_UP/*KEY_DOWN-down*/,TPD_GES_KEY_DOUBLECLICK/*KEY_DOT-doubel*/
 };
s32 gesture_event_handler(struct input_dev * dev)
{
	...
	GTP_DEBUG("Gesture: 0x%02X, points: %d", doze_buf[0], doze_buf[1]);
		...
		for(drv_i = 0; drv_i < DRV_CTP_GESTURE_NUM;drv_i++)
		{
			
			if(drv_ctp_str[drv_i] == ges_type)
			{
	                    GTP_INFO("Double click to light up the screen!");
	               //     doze_status = DOZE_WAKEUP;
	                    input_report_key(dev, drv_ctp_num[drv_i], 1); // input_report_key(tpd->dev, drv_ctp_num[drv_i], 1);
	                    input_sync(dev);
	                     input_report_key(dev, drv_ctp_num[drv_i], 0);//  input_report_key(tpd->dev, drv_ctp_num[drv_i], 0);
	                    input_sync(dev);	                
			    break;
			}
                }		
