...
static unsigned char CTPM_FW[] = {
	#include "RC-0229-L1_20160822_app.i"
};
...
int fts_ctpm_auto_upgrade(struct i2c_client *client)
{
	...
	printk("lipeiyang touchpanel upgrade uc_tp_fm_ver = 0x%x,uc_tp_fm_ver = 0x%x,uc_host_fm_ver = 0x%x\n",uc_tp_fm_ver,uc_tp_fm_ver,uc_host_fm_ver);
	if ((uc_tp_fm_ver == FTS_REG_FW_VER ||   uc_tp_fm_ver < uc_host_fm_ver ) && (uc_tp_fm_ver == 244 && uc_host_fm_ver == 132))
	{
		printk("lipeiyang touchpanel succeed\n");
		msleep(100);
