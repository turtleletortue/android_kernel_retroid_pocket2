...
//yan
#ifdef CONFIG_REAL_EXT_AMP
#include "AudDrv_Gpio.h"
#endif
//yan end

#define __AUDIO_SPERKER_EN_18__			18
...
void set_pa_audio_mode(int nOpenOrClose)
{
	if(nOpenOrClose)
	{
		gpio_set_value(__AUDIO_SPERKER_EN_18__,1);
		udelay(2);
		gpio_set_value(__AUDIO_SPERKER_EN_18__,0);
		udelay(2);
		gpio_set_value(__AUDIO_SPERKER_EN_18__,1);
		//udelay(2);
		//gpio_set_value(__AUDIO_SPERKER_EN_8__,0);
		//udelay(2);
		//gpio_set_value(__AUDIO_SPERKER_EN_8__,1);
	}
	else
	{
		gpio_set_value(__AUDIO_SPERKER_EN_18__,0);
