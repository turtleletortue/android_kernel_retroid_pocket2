...
/**
 * sefs_write
 * @sefs_inode: The Sefs file into which to write
 * @data: Virtual address where data to write is located
 * @offset: Offset in the Sefs file at which to begin writing the
 *          data from @data
 * @size: The number of bytes to write from @data
 *
 * Write an arbitrary amount of data to an arbitrary location in the
 * Sefs inode page cache. This is done on a page-by-page, and then
		   ...
		   size_t size)
{
	...
	while (pos < (offset + size)) {
		pgoff_t sefs_page_idx = (pos >> PAGE_CACHE_SHIFT);
 ...
 * @page_for_sefs: The page into which data for Sefs will be
 *                     written
